 ...
 * temperature scale the user wants to convert it to. If both the temperature in 
 * Fahrenheit and the temperature scale are valid, the program converts the 
 * temperature in Fahrenheit to the specified temperature scale and displays the 
 * converted value.
 *
...
//package TemperatureConverter; Remove package declaration at the top
